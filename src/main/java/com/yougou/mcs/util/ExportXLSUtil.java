...
public class ExportXLSUtil {
	...
	public static HSSFWorkbook exportExcel(String title, String[] headers,
			List<Object[]> dataset, Boolean[] amounts) {
	 ...
	 * * @param workbook excel操作对象
	    ...
	    * @param amounts 是否为金额
	    */
		public static boolean exportExcel(HSSFWorkbook workbook,String title, String[] headers, List<Object[]> dataset, Boolean[] amounts) 
		{
			if(headers==null || headers.length==0)
			{
				return false;
	 ...
	 * @param headStyle
	 */
	private static void fillHead(HSSFSheet sheet, String[] headers,
	 ...
	 * @param moneyStyle
	 */
	private static void fillData(HSSFSheet sheet, List<Object[]> dataset,
			int fIndex, int lIndex, Boolean[] amounts, HSSFCellStyle dataStyle,
			HSSFCellStyle moneyStyle) {
		HSSFRow row = null;
		int rowNum = 0;
	 ...
	 * @return
	 */
	public static void saveExcel(String title, String[] headers,
			List<Object[]> dataset, Boolean[] amounts, String filePath) {
		HSSFWorkbook workbook = exportExcel(title, headers, dataset, amounts);
